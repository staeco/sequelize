...
class Query extends AbstractQuery {
    ...
    formatError(err) {
        ...
        match =
            err.message.match(/Failed on step '(.*)'.Could not create constraint. See previous errors./) ||
    ...
    isShowOrDescribeQuery() {
        ...
        result =
            result ||
                this.sql
                    .toLowerCase()
                    .startsWith("select c.column_name as 'name', c.data_type as 'type', c.is_nullable as 'isnull'");
