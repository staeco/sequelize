...
class PostgresQueryGenerator extends AbstractQueryGenerator {
  ...
  showIndexesQuery(tableName) {
    ...
    return (
      ...
      `(t.relkind = 'r' OR i.relkind = 'I') and t.relname = '${tableName}'${schemaWhere} ` +
  ...
  getForeignKeysQuery(tableName) {
    return (
      'SELECT conname as constraint_name, pg_catalog.pg_get_constraintdef(r.oid, true) as condef FROM pg_catalog.pg_constraint r ' +
  ...
  getForeignKeyReferencesQuery(tableName, catalogName, schemaName) {
    return `${this._getForeignKeyReferencesQueryPrefix()}WHERE constraint_type = 'FOREIGN KEY' AND tc.table_name = '${tableName}'${
  ...
  getForeignKeyReferenceQuery(table, columnName) {
    ...
    return `${this._getForeignKeyReferencesQueryPrefix()}WHERE constraint_type = 'FOREIGN KEY' AND tc.table_name='${tableName}' AND  kcu.column_name = '${columnName}'${
