      ...
      it('show indexes', () => {
        expectsql(sql.showIndexesQuery('table'), {
          postgres:
            ...
            "(t.relkind = 'r' OR i.relkind = 'I') and t.relname = 'table' GROUP BY i.relname, ix.indexrelid, ix.indisprimary, ix.indisunique, ix.indkey ORDER BY i.relname;"
        });
        ...
        expectsql(sql.showIndexesQuery({ tableName: 'table', schema: 'schema' }), {
          postgres:
            ...
            'WHERE t.oid = ix.indrelid AND i.oid = ix.indexrelid AND a.attrelid = t.oid AND ' +
            "(t.relkind = 'r' OR i.relkind = 'I') and t.relname = 'table' AND s.oid = t.relnamespace AND s.nspname = 'schema' " +
